    ...
    <div>
      ...
      {[
        ...
        },
        {
          ...
          content:
            "When we are done, and you learn a more [resourceful response](/loss/resourceful-response) to loss, you can decide how much you'd love to [pay](/i-dont-charge-i-accept) 💖",
        },
        {
...
`,
      ...
      {[
        {
          title:
            "Wouldn't people think I don't care for the person if I'm not in pain?",
          content: `
...
`,
        ...
        {
          title:
            "I'm afraid that if I experience him vividly, I'll want to go be with him",
          content: `
...
`,
        ...
        {
          title:
            "If I experienced the loss as being here with me, people would think I'm nuts",
          content: `
...
function renderCollapsible({ title, content }) {
  return (
    <Collapsible
      trigger={<span style={{ fontStyle: 'italic' }}>{title}</span>}
      key={title}
    >
