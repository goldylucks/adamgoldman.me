        ...
        <div className='container'>
          <div className={`mainheading ${s.widthContainer}`}>
            <h1 className='sitetitle text-center'>
              How to honor your child&apos;s memory after the transition
            </h1>
          ...
          <div className='text-center' style={{ marginBottom: 20 }}>
            ...
            <span>
              Source:{' '}
              <ExternalA href='http://yourtribute.com'>
                yourtribute.com
              </ExternalA>
            </span>
          </div>
          <div className={s.widthContainer}>
            <p>
              Losing your child is one of{' '}
              <strong>
                the most devastating experiences a parent can go through
              </strong>
              .
            </p>
            <p>
              The unconditional love, acceptance, connection ... It’s something
              you rarely get to feel anywhere else.
            </p>
            <hr className={s.hr} />
            <h4
              ref={el => {
            ...
            >
              “The loss of a child is the most devastating experience a parent
              can face - and missing the child never goes away. A piece of
              yourself is lost and your future is forever changed.” <br />-{' '}
              <strong>Margo F. Weiss, PhD.</strong>
            </h4>
            <hr className={s.hr} />
            ...
            <p>
              ...
              you and fellow parents are feeling right now.
            </p>
            <p>
              I’ve talked and listened to hundreds of parents just like you, and
            ...
            <p>
              ...
              your precious child in a way that honors them,{' '}
              <strong>treasure the good experiences</strong> you shared, and
              everything that that relationship has given you.
            </p>
            <p>
            ...
            <div>{this.renderBuyNowScrollButton()}</div>
            <hr className={s.hr} />
          ...
          <div>
            ...
            <div>{this.renderFinalPrice()}</div>
            <div>{this.renderPaymentButton()}</div>
            <div>{this.renderPaypalSecure()}</div>
          </div>
          <div className={s.widthContainer}>
            <hr className={s.hr} />
            <p>
            ...
            <p>
              ...
              free $100 worth session. Either way, it’s a win-win for you.
            </p>
            <hr className={s.hr} />
            ...
            <p>
              ...
              child, you have the opportunity to literally rewire your mind to{' '}
              <strong>
            ...
            <p>
              ...
              <strong>let the qualities you appreciate</strong> in your child
              compel and <strong>draw you forward</strong> to an ever{' '}
            ...
            <p style={{ marginTop: 40 }}>
              <strong>P.S.</strong>Yes, you can literally rewire your mind, body
              and feelings, to transform your current grief to feeling of
              appreciation, in way that will honor your lost child in a
              comprehensive way.
            </p>
            <p>
              <strong>P.P.S. </strong>Remember all the risk is on me, so when
      ...
      <section>
        ...
        <div className='row justify-content-md-center'>
          <div className='col col-lg-10'>
            ...
            <div className={s.painPoint}>
              - &quot;All I feel is sorrow & loss&quot;{' '}
            </div>
            <div className={s.painPoint}>
              - &quot;This pain will never go away&quot;{' '}
            </div>
            <p>
              If any of the above feel familiar to you, please realize you are
              NOT alone in this!
            </p>
            <p>
              Many parents Ive worked with felt the same way before doing the
              program.
            </p>
          </div>
        </div>
  ...
  renderPartenrshipsSection() {
    return (
      ...
      >
        ...
        <p className='lead'>
          I work closely with Helping Parents Heal, a non profit organization
          dedicated to support parents in a very accepting, loving, non
          judgemental way, regardless of personal belief.
        </p>
        <img
        ...
        <p className='lead'>
          Connirae and Steve and have developed the base for many of the
          processes we will work together through, among countless other books,
        ...
        <blockquote style={{ marginTop: 20 }}>
          ...
          <br />
          <br />
          He has created open-source online programs to guide parents through
          ...
          <br />
          <br />
          His work is a detailed challenge to the rest of us to learn how to “up
          our game” or be left behind in the dustbin of history.
          <br />
    ...
    return (
      ...
      >
        ...
        <div className={s.aboutContainer}>
          ...
          />
          <p className='lead'>
            I&apos;ve been guiding people through personal change processes for
            over 8 years. My latest focus is helping you (and fellow parents)
            savor the relationship with your child, to align your brain, mind
            and body, towards a compelling brightening future, and let the light
            of your child shine through you as you carry it wherever you go.
          </p>
        </div>
      </section>
    )
      ...
      <nav className='navbar navbar-expand-lg fixed-top main-nav navbar-light'>
        <div className='container'>
          <MobileNav
            ...
            title={title}
          />
          <Link className='navbar-brand mr-auto' to='/savoring-your-child'>
            {title}
          </Link>
    ...
    return (
      <div>
        <div>
          ...
          <p>
            We’ll go over 5 common aspects of grief and carefully separate them
        ...
        <div>
          ...
          <p>
            ...
            your mind to go back to the happy memories. This will also{' '}
            <strong>pacify disturbing or graphic images</strong> you might still
            have. <br /> <strong>✔️ Value: $47</strong>
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            be, and events you might have planned with and for your child.
        ...
        <div>
          ...
          <p>
            Some days of the year are usually harder than others, like
            birthdays, memorial days and holidays. In this process you learn how
            to use these days as an opportunity to remind yourself how lucky you
            are to have had them in your life, reminisce about your relationship
            and honor it even more. <br /> <strong>✔️ Value: $47</strong>
          </p>
        </div>
        <div>
