...
export default [
  ...
  {
    title:
      'דורה טליאס - ניקוי אבל ואבדן, געגועים לבעל, אכזבה, כעס, עצב ואבחון של סרטן',
  ...
  },
  {
    ...
    description:
      'Jennifer had anxiety, obsessive thoughts, compulsive behaviors and rituals for as long as she can remember. Today she has no more guilt, no anxiety, and ...',
    tags: ['OCD', 'Guilt', 'Trauma', 'Intrusive Thoughts', 'Successes'],
  ...
  {
    title:
      'A Mind for Numbers - How to Excel at Math and Science Review & Summary',
    tags: ['Books', 'Learning To Learn'],
  ...
  },
  {
    ...
    description:
      'Coffee is Unhealthy right? This is one of those cases where it feels so good to be wrong :)',
  ...
  },
  {
    ...
    tags: ['Optimize Performance', 'Health'],
    url: 'tea',
  },
  {
