...
import {
  MESSENGER_LINK_SAVORING_YOUR_CHILD_PURCHASE_INTRO,
  MAIL_TO_LINK,
} from '../../constants'
        ...
        <div className='container'>
          <div className={`mainheading ${s.widthContainer}`}>
            ...
            <p>
              ...
              &quot;Savoring Your Child&quot; customers.
            </p>
            <p>
              After you click the &apos;get started&apos; button below, I will
              send you the first step.
            </p>
            <ExternalA
              className='btn btn-primary'
              href={MESSENGER_LINK_SAVORING_YOUR_CHILD_PURCHASE_INTRO}
            >
              Get Started
            </ExternalA>
