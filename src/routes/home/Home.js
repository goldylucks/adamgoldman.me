      ...
      <div>
        <div className="container">
          <div className="mainheading">
            ...
            <p className="lead">Hack your mind, body, and personality. Transform your life.</p>
            <div className="text-center">
              <Link href="/book-session" className="btn btn-primary cta-button">BOOK A SESSION</Link>
            </div>
            <Markdown source="
